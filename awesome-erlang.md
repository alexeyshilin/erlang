...
* [sky-big/RabbitMQ](https://github.com/sky-big/RabbitMQ) - RabbitMQ system version 3.5.3 is fully annotated in Chinese (at the same time, it realizes RabbitMQ system and plug-in source code compilation, creates a RabbitMQ cluster according to the configuration file, creates a client node connected to the RabbitMQ system and other related functions, which is convenient for reading the source code)
* [aeternity/aeternity](https://github.com/aeternity/aeternity) - Ã¦ternity: solving scalability problems by making sense of state-channels
...
* [ostinelli/misultin](https://github.com/ostinelli/misultin) - Misultin (pronounced mee-sool-tÃ©en) is an Erlang library for building fast lightweight HTTP(S) servers, which also supports websockets.
...
* [@0xAX](https://github.com/OtpChatBot/Ybot)[OtpChatBot/Ybot] - Ybot - is a helpful chat robot written with Erlang which supports different messaging protocols. 
* [okeuday/uuid](https://github.com/okeuday/uuid) - Erlang Native UUID Generation
* [Erlang](https://github.com/msgpack/msgpack-erlang)[msgpack/msgpack-erlang] - MessagePack (de)serializer implementation for Erlang / msgpack.org
...
* [synrc/mad](https://github.com/synrc/mad) - âš¡ MAD: Manage Dependencies
...
* [groupoid/pure](https://github.com/groupoid/pure) - â™¾ PTS: Pure Type System for Erlang
...
* ["Erlang VM"](https://github.com/msantos/evum)[msantos/evum] - ["Linux VM", ["Erlang Process", ]].
...
* [MIRROR](https://github.com/G-Corp/vice)[G-Corp/vice] -  Video, audio and Image Converter for Erlang/Elixir
...
* [b0oh/lol](https://github.com/b0oh/lol) - Lol â€” Lisp on erLang, and programming is fun again
...
* [evanmiller/jerome](https://github.com/evanmiller/jerome) - Erlang rich-text processing library ğŸ“œ
...
* [mad-cocktail/gin](https://github.com/mad-cocktail/gin) - The guards <code>in</code> and <code>beetween</code> for Erlang parse_transform
...
* [MIRROR](https://github.com/G-Corp/jwerl)[G-Corp/jwerl] -  Erlang JWT Library
...
* [JonGretar/erlangxcode](https://github.com/JonGretar/erlangxcode) - <em>OUTDATED</em> Erlang plugin for the XCode 3 IDE
...
* [Abandoned](https://github.com/henry-hz/erlang-trader)[henry-hz/erlang-trader] - Porting the AlgoTrader (Java) code to Erlang  
...
* [squaremo/erlmqtt](https://github.com/squaremo/erlmqtt) - MQTT library for Erlang <em>JUST USABLE</em>
...
* [unmaintained](https://github.com/6/heroku-erlang-example)[6/heroku-erlang-example] -  erlang example using webmachine, hosted on heroku
...
* [Naupio/dolphingame](https://github.com/Naupio/dolphingame) - <strong>pigame</strong> is a game server template for Erlang.
...
* [Naupio/dolphin](https://github.com/Naupio/dolphin) - <strong>pigame</strong> is a game server template for Erlang.
...
* [Naupio/pigame](https://github.com/Naupio/pigame) - <strong>pigame</strong> is a game server template for Erlang.
