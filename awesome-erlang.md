...
* (https://github.com/tarcieri/reia)[tarcieri/reia] - Ruby-like hybrid OOP/functional programming language for BEAM, the Erlang VM
...
* (https://github.com/moonpolysoft/dynomite)[moonpolysoft/dynomite] - Open source dynamo clone written in Erlang.
...
* (https://github.com/andrewjstone/rafter)[andrewjstone/rafter] - An Erlang library application which implements the Raft consensus protocol
...
* (https://github.com/cuter-testing/cuter)[cuter-testing/cuter] - A concolic testing tool for the Erlang functional programming language.
...
* (https://github.com/midas-framework/midas)[midas-framework/midas] - A web framework for Gleam, Midas makes shiny things.
...
* (https://github.com/erszcz/docsh)[erszcz/docsh] - Erlang Docs in the Shell predating EEP-48 and shell_docs
...
* (https://github.com/artemeff/eql)[artemeff/eql] - Erlang with SQL or not
...
* (https://github.com/chef-boneyard/erchef)[chef-boneyard/erchef] - DEPRECATED: Erlang based Chef Server top-level OTP release project
...
* (https://github.com/kafka4beam/kafka_protocol)[kafka4beam/kafka_protocol] - Kafka protocol erlang library
...
* (https://github.com/benoitc/erlang-metrics)[benoitc/erlang-metrics] - A generic interface to different metrics systems in Erlang.
...
* (https://github.com/Darkkey/erlamsa)[Darkkey/erlamsa] - Erlang port of famous radamsa fuzzzer.
...
* (https://github.com/mattsta/ecache)[mattsta/ecache] - ecache: Erlang ETS Based TTL Cache
...
* (https://github.com/richcarl/erlguten)[richcarl/erlguten] - ErlGuten is a system for high-quality typesetting, written purely in Erlang. This is the canonical repository, representing the latest official release, now under the MIT license. (The link below points to the old, outdated project page.)
...
* (https://github.com/whitfin/sleeplocks)[whitfin/sleeplocks] - BEAM friendly spinlocks for Elixir/Erlang
...
* (https://github.com/ndpar/erlang)[ndpar/erlang] - My Erlang/OTP library
...
* (https://github.com/eproxus/pretty_errors)[eproxus/pretty_errors] - Error and stack trace pretty printers for Erlang
...
* (https://github.com/jcomellas/kvlists)[jcomellas/kvlists] - Lists of key-value pairs (decoded JSON) in Erlang
...
* (https://github.com/andelf/erlang-proxy)[andelf/erlang-proxy] - socks4, socks4a, socks5 proxy, encrypted, derived from yueyoum/make-proxy. Across the Great Wall we can reach every corner in the world.
...
* (https://github.com/richcarl/sendmail)[richcarl/sendmail] - Erlang sendmail interface
...
* (https://github.com/unbalancedparentheses/erlskeletor_cowboy)[unbalancedparentheses/erlskeletor_cowboy] - :neckbeard: Erlang skeleton with cowboy and common test
...
* (https://github.com/mattsta/pcache)[mattsta/pcache] - An Erlang cache where every stored item is its own process.
* (https://github.com/marianoguerra/interfix)[marianoguerra/interfix] - an experimental programming language for the erlang vm that is actually useful
* (https://github.com/marianoguerra/erldn)[marianoguerra/erldn] - edn format parser for the erlang platform
* (https://github.com/loguntsov/reliable_udp)[loguntsov/reliable_udp] - Reliable protocol over UDP for Erlang
* (https://github.com/kzemek/macaroons)[kzemek/macaroons] - An Erlang Macaroons library compatible with libmacaroons
* (https://github.com/jpgneves/iota)[jpgneves/iota] - iota (Inter-dependency Objective Testing Apparatus) - a tool to enforce clean separation of responsibilities in Erlang code
* (https://github.com/jixiuf/helloerlang)[jixiuf/helloerlang] - my   repos for erlang test code .
* (https://github.com/hypernumbers/erlang-wtd)[hypernumbers/erlang-wtd] - Creating a mutant army of self-discovering Raspberry Pi Erlang robots for world domination or something...
* (https://github.com/hpyhacking/webtekcos)[hpyhacking/webtekcos] - a websocket server in erlang
* (https://github.com/hamidreza-s/Queuesk)[hamidreza-s/Queuesk] - Priority Task Queue for Erlang
* (https://github.com/erszcz/pa)[erszcz/pa] - Partial application of Erlang functions
* (https://github.com/emqx/replayq)[emqx/replayq] - Generic on-disk persistent queue implementation for Erlang
* (https://github.com/devinus/zucchini)[devinus/zucchini] - An Erlang INI parser
* (https://github.com/ddossot/cferl)[ddossot/cferl] - Rackspace / Open Stack Cloud Files Erlang Client
* (https://github.com/chef/mini_s3)[chef/mini_s3] - Minimal AWS S3 client for Erlang
* (https://github.com/bokner/gen_client)[bokner/gen_client] - Generic XMPP client framework for Erlang
* (https://github.com/auser/erlfs)[auser/erlfs] - A distributed storage system which uses distributed Erlang strongly influenced by http://dawsdesign.com/drupal/erlfs
* (https://github.com/wardbekker/search)[wardbekker/search] - Erlang implementation of  WAND/max_score TOP-K retrieval algo.
* (https://github.com/spawngrid/validaterl)[spawngrid/validaterl] - Data validation library for Erlang
* (https://github.com/paulzql/shadowsocks-erlang)[paulzql/shadowsocks-erlang] - erlang port of shadowsocks (The next generation is elixir  http://github.com/paulzql/shadowsocks-ex )
* (https://github.com/omarkj/erollbar)[omarkj/erollbar] - Rollbar client in Erlang
* (https://github.com/okeuday/reltool_util)[okeuday/reltool_util] - Erlang reltool utility functionality application
* (https://github.com/maxlapshin/csv_reader)[maxlapshin/csv_reader] - Fast erlang csv reader
* (https://github.com/mattsta/stripe-erlang)[mattsta/stripe-erlang] - Erlang interface to the stripe.com API
* (https://github.com/lindenbaum/eipmi)[lindenbaum/eipmi] - A native Erlang IPMI library.
* (https://github.com/klarna/kastle)[klarna/kastle] - Kafka REST proxy
* (https://github.com/jj1bdx/tinymt-erlang)[jj1bdx/tinymt-erlang] - This software is no longer maintained. For archive/reference use only. -- Tiny Mersenne Twister (TinyMT) for Erlang
* (https://github.com/inaka/canillita)[inaka/canillita] - Simple Paperboy-themed PubSub
* (https://github.com/hiroeorz/arduino-erlang)[hiroeorz/arduino-erlang] - Arduino handler for Erlang/OTP Application.
* (https://github.com/helium/BEAMCoin)[helium/BEAMCoin] - A sample Erlang blockchain in less than 500 lines of code
* (https://github.com/farhadi/cuckoo_filter)[farhadi/cuckoo_filter] - High-performance, concurrent, and mutable Cuckoo Filter for Erlang and Elixir
* (https://github.com/edgurgel/poxa-erlang)[edgurgel/poxa-erlang] - Open Pusher server implementation compatible with Pusher libraries.
* (https://github.com/ates/netspire-core)[ates/netspire-core] - The Erlang RADIUS server and NetFlow v5, v9 collector
* (https://github.com/altenwald/forseti)[altenwald/forseti] - Process balancer and distributor for Erlang/OTP
* (https://github.com/aeternity/app_ctrl)[aeternity/app_ctrl] - Alternative application controller for Erlang/OTP
* (https://github.com/abuibrahim/erlang-http)[abuibrahim/erlang-http] - Modular, RFC 2616 compliant HTTP/1.1 server and client
* (https://github.com/zuiderkwast/erlang_abstract_format)[zuiderkwast/erlang_abstract_format] - Documentation of Erlang Abstract Format
* (https://github.com/yoonka/migresia)[yoonka/migresia] - A simple Erlang tool to automatically migrate Mnesia databases between versions
* (https://github.com/treacheroustalks/Treacherous-Talks)[treacheroustalks/Treacherous-Talks] - An online implementation of the Diplomacy board game in Erlang.
* (https://github.com/tex/ssync)[tex/ssync] - Stay in sync in rebarized erlang projects
* (https://github.com/talentdeficit/json)[talentdeficit/json] - a high level json library for erlang (17.0+)
* (https://github.com/simonstl/introducing-erlang-2nd)[simonstl/introducing-erlang-2nd] - Code samples from Introducing Erlang, second edition
* (https://github.com/seriyps/xhttpc)[seriyps/xhttpc] - Extensible HTTP Client for  Erlang
* (https://github.com/rjdellecese/gleam_decode)[rjdellecese/gleam_decode] - Transform Erlang or Elixir data into Gleam data
* (https://github.com/palkan/erlgrpc)[palkan/erlgrpc] - GRPC client for Erlang
* (https://github.com/ostinelli/cowbell)[ostinelli/cowbell] - An Erlang node connection manager.
* (https://github.com/ngerakines/s3imagehost)[ngerakines/s3imagehost] - An erlang powered image store using amazon s3.
* (https://github.com/m-2k/erlach)[m-2k/erlach] - â˜£âš«âš« SPA Imageboad on WebSockets written on Erlang
* (https://github.com/jr0senblum/jc)[jr0senblum/jc] - Erlang, in-memory distributable cache
* (https://github.com/jcomellas/bstr)[jcomellas/bstr] - Erlang library to use binaries as strings
* (https://github.com/hauleth/gen_icmp)[hauleth/gen_icmp] - ICMP protocol implementation for Erlang without NIFs
* (https://github.com/habibutsu/erlz)[habibutsu/erlz] - Set of helpers functions for more convenient functional programming in Erlang
* (https://github.com/fhunleth/relsync)[fhunleth/relsync] - Synchronize Erlang/OTP releases to remote nodes
* (https://github.com/ferd/useragent)[ferd/useragent] - Identify browsers and OSes from user agent strings, in Erlang
* (https://github.com/ferd/howistart-erlang1-code)[ferd/howistart-erlang1-code] - Code for my tutorial on howistart.org
* (https://github.com/exograd/erl-hotp)[exograd/erl-hotp] - HOTP and TOTP algorithms in Erlang.
* (https://github.com/cstar/ec2nodefinder)[cstar/ec2nodefinder] - erlang node auto-discovery on EC2
* (https://github.com/cmoid/erlbutt)[cmoid/erlbutt] - erlang prototype of scuttlebutt protocol
* (https://github.com/bwegh/awre)[bwegh/awre] - A wamp.ws client written in erlang
* (https://github.com/benoitc/sieve)[benoitc/sieve] - sieve is a simple TCP routing proxy (layer 7) in erlang
* (https://github.com/bef/erlswf)[bef/erlswf] - Erlang SWF (Flash) file analysis toolkit
* (https://github.com/beam-telemetry/telemetry_registry)[beam-telemetry/telemetry_registry] - A library for declaration and discovery of telemetry events
* (https://github.com/barrel-db/hlc)[barrel-db/hlc] - hlc - Hybrid Logical Clock in Erlang.
* (https://github.com/asceth/nehe_erlang)[asceth/nehe_erlang] - NeHe OpenGL tutorials ported to Erlang
* (https://github.com/andytill/oneup)[andytill/oneup] - NIF powered global counters for erlang
* (https://github.com/alavrik/piqi-rpc)[alavrik/piqi-rpc] - RPC-over-HTTP system for Erlang supporting JSON, XML and Protocol Buffers
* (https://github.com/ThomasHabets/eggpd)[ThomasHabets/eggpd] - Erlang BGP daemon
* (https://github.com/tamarit/edbc)[tamarit/edbc] - Erlang Design by Contract
* (https://github.com/seth/sherl)[seth/sherl] - A URL Shortening Service Written in Erlang
* (https://github.com/reiddraper/fn)[reiddraper/fn] - Function utilities for Erlang
* (https://github.com/rambocoder/unistring)[rambocoder/unistring] - Unicode utf-8 functions for Erlang
* (https://github.com/project-fifo/ensq)[project-fifo/ensq] - NSQ Client for erlang
* (https://github.com/ostrovok-team/ejsonpath)[ostrovok-team/ejsonpath] - JSONPath Erlang implementation
* (https://github.com/marinakr/libphonenumber_erlang)[marinakr/libphonenumber_erlang] - Library validates mobile phone number for country
* (https://github.com/lemenkov/erlpmd)[lemenkov/erlpmd] - A drop-in replacement for epmd written in Erlang
* (https://github.com/hbcrhythm/kcp_erlang)[hbcrhythm/kcp_erlang] - A Reliable-UDP Library for erlang
* (https://github.com/graphql-erlang/graphql)[graphql-erlang/graphql] - Erlang GraphQL implementation
* (https://github.com/gar1t/erlang-bench)[gar1t/erlang-bench] - Various Erlang related benchmarks
* (https://github.com/g-andrade/deigma)[g-andrade/deigma] - Event sampler
* (https://github.com/filmor/ierl)[filmor/ierl] - BEAM Jupyter Kernels Tool
* (https://github.com/echou/memcached-client)[echou/memcached-client] - an Erlang memcached client application
* (https://github.com/doubleyou/euthanasia)[doubleyou/euthanasia] - Merciful killer for your Erlang processes
* (https://github.com/Vonmo/rocker)[Vonmo/rocker] - Erlang/Elixir wrapper for RocksDB
* (https://github.com/RJ/erlang_rebar_example_project)[RJ/erlang_rebar_example_project] - Basic project using rebar, to demonstrate upgrades and packaging etc
* (https://github.com/KrzysiekJ/gb_merkle_trees)[KrzysiekJ/gb_merkle_trees] - General balanced binary Merkle trees for Erlang
* (https://github.com/K2InformaticsGmbH/dderl)[K2InformaticsGmbH/dderl] - Web based Data Explorer / Data Jump Station with Erlang In-Memory Support
* (https://github.com/HernanRivasAcosta/kafkerl)[HernanRivasAcosta/kafkerl] - Apache Kafka producer/consumer for erlang
* (https://github.com/EchoTeam/corman)[EchoTeam/corman] - Configuration reload manager for Erlang applications
* (https://github.com/AdRoll/spillway)[AdRoll/spillway] - An Erlang OTP application for load shedding
* (https://github.com/Supersonido/rebar_mix)[Supersonido/rebar_mix] - rebar3 plugin for building Elixir dependencies with mix
* (https://github.com/mrDoctorWho/ejabberd_mod_gcm)[mrDoctorWho/ejabberd_mod_gcm] - Google Cloud Messaging API for Ejabberd (PUSH Messages)
* (https://github.com/k32/typerefl)[k32/typerefl] - Use Erlang typespecs in the runtime
* (https://github.com/leandrosilva/otp_kickoff)[leandrosilva/otp_kickoff] - Simple generator to kick-off Erlang/OTP projects
* (https://github.com/etnt/ehotp)[etnt/ehotp] - Erlang implementation of the HOTP algoritm (RFC-4226)
* (https://github.com/6/heroku-erlang-example)[6/heroku-erlang-example] - [unmaintained] erlang example using webmachine, hosted on heroku
* (https://github.com/artemeff/raven-erlang)[artemeff/raven-erlang] - Sentry client for Erlang
* (https://github.com/tonyg/erlang-ircd)[tonyg/erlang-ircd] - A pluggable IRC daemon application/library for Erlang.
* (https://github.com/tomas-abrahamsson/tdiff)[tomas-abrahamsson/tdiff] - Diff algorithm in Erlang
* (https://github.com/brendonh/erl_openid)[brendonh/erl_openid] - Erlang OpenID
* (https://github.com/NetComposer/nkservice)[NetComposer/nkservice] - Erlang Services Management
* (https://github.com/dgiot/dgiot)[dgiot/dgiot] - DG-IoTï¼ŒOpen-sourceÂ IoTÂ Platform - Connect management,Device management,Data collection, Processing and Visualization.High concurrency, light weight, low code, fast access, free platform. Industry SaaS for IoT Platform.ç‰©è�”ç½‘å¼€æº�å¹³å�°ï¼Œç‰©è�”ç½‘å¹³å�°å¼€å�‘ï¼Œè¿�æ�¥ç®¡ç�†ã€�è®¾å¤‡ç®¡ç�†ã€�å¤šå·¥ä¸šå��è®®å…¼å®¹ã€�æ•°æ�®é‡‡é›†ã€�å�¯è§†åŒ–å¼€å�‘ã€�é«˜å¹¶å�‘ã€�è½»é‡�çº§ã€�ä½�ä»£ç �ã€�å¿«æ�¥å…¥ã€�å¹³å�°å…�è´¹ã€‚
* (https://github.com/spawnfest/eflambe)[spawnfest/eflambe] - A tool for rapid profiling of Erlang and Elixir applications
* (https://github.com/tangyi1989/erl_game_server)[tangyi1989/erl_game_server] - Erlang game server framework for fun.
* (https://github.com/benoitc/inet_cidr)[benoitc/inet_cidr] - CIDR erlang library
* (https://github.com/apauley/sudoku-in-erlang)[apauley/sudoku-in-erlang] - An implementation of Norvig's sudoku solver in Erlang
* (https://github.com/RJ/erlang-reup)[RJ/erlang-reup] - Watches for .erl &amp; .hrl changes, recompiles and reloads. You know, for development.
* (https://github.com/syed/erlcscope)[syed/erlcscope] - Program which builds cscope database for erlang files
* (https://github.com/ngerakines/erlang_mysql)[ngerakines/erlang_mysql] - A GitHub mirror of the native Erlang MySQL client library.
* (https://github.com/joergen7/effi)[joergen7/effi] - Erlang foreign function interface.
* (https://github.com/bfrog/hottub)[bfrog/hottub] - Simple, Fast, Permanent Erlang Worker Pool
* (https://github.com/gar1t/port_server)[gar1t/port_server] - A super simple framework for extending Erlang supervision to external apps
* (https://github.com/dploop/esugar)[dploop/esugar] - An Erlang Syntactic Sugar Library
* (https://github.com/Vagabond/diemap)[Vagabond/diemap] - An extensible IMAP server for Erlang
* (https://github.com/Naupio/dolphingame)[Naupio/dolphingame] - <strong>pigame</strong> is a game server template for Erlang.
* (https://github.com/erlangcode/erlang-oauth)[erlangcode/erlang-oauth] - An Erlang OAuth 1.0 implementation
* (https://github.com/cannedprimates/stdlib2)[cannedprimates/stdlib2] - Erlang stdlib extensions.
* (https://github.com/mrallen1/gisla)[mrallen1/gisla] - A library that implements the sagas pattern for Erlang
* (https://github.com/mrallen1/parque)[mrallen1/parque] - Erlang trading game engine
* (https://github.com/xvw/coers)[xvw/coers] - A small library for coercion to primitive Erlang types.
* (https://github.com/tim/erlang-oauth)[tim/erlang-oauth] - An Erlang OAuth 1.0 implementation
* (https://github.com/indigo-dc/oidcc)[indigo-dc/oidcc] - OpenId Connect client library in Erlang
* (https://github.com/a13x/ezmtp)[a13x/ezmtp] - ZMTP protocol in pure Erlang.
* (https://github.com/pouriya/sockerl)[pouriya/sockerl] - Sockerl is an  advanced Erlang/Elixir socket framework for TCP protocols and provides fast, useful and easy-to-use API for implementing servers, clients and client connection pools.
* (https://github.com/Naupio/dolphin)[Naupio/dolphin] - <strong>pigame</strong> is a game server template for Erlang.
* (https://github.com/rvirding/lfe)[rvirding/lfe] - Lisp Flavoured Erlang (LFE)
* (https://github.com/gbour/wave)[gbour/wave] - MQTT Broker - for IoT, DIY, pubsub applications and more
* (https://github.com/cchandler/RTreeCouchDB)[cchandler/RTreeCouchDB] - Erlang R-Tree implementation I'm going to try and move into CouchDB for n-dimensional spatial indexing
* (https://github.com/rcouch/ecsv)[rcouch/ecsv] - Erlang CSV Parser
* (https://github.com/jlouis/erlang-utp)[jlouis/erlang-utp] - uTP implementation in Erlang
* (https://github.com/Klimiec/Erlang)[Klimiec/Erlang] - Erlang exercises with answers
* (https://github.com/edescourtis/ebitcoind)[edescourtis/ebitcoind] - Erlang to Bitcoind API
* (https://github.com/RJ/erlang-cassandra-cql)[RJ/erlang-cassandra-cql] - cassandra driver in erlang that speaks native cassandra protocol
* (https://github.com/klarna/brod)[klarna/brod] - Apache Kafka client library for Erlang/Elixir
* (https://github.com/klarna/kafka_protocol)[klarna/kafka_protocol] - Kafka protocol erlang library
* (https://github.com/sheyll/erlymock)[sheyll/erlymock] - An EasyMock inspired mocking library for erlang.
* (https://github.com/rramsden/gen_gossip)[rramsden/gen_gossip] - Interface for implementing Gossip Protocols in Erlang
* (https://github.com/jarrodhroberson/inet_mdns)[jarrodhroberson/inet_mdns] - Bonjour / Zeroconf in Erlang
* (https://github.com/idubrov/siperl)[idubrov/siperl] - RFC 3261 (SIP) implementation in Erlang
* (https://github.com/Naupio/pigame)[Naupio/pigame] - <strong>pigame</strong> is a game server template for Erlang.
* (https://github.com/samuelrivas/moka)[samuelrivas/moka] - A mocking (more precisely moking) framework for erlang
* (https://github.com/msantos/wierl)[msantos/wierl] - Erlang interface for manipulating 802.11 wireless devices
* (https://github.com/msantos/erlxc)[msantos/erlxc] - Simple, safe erlang interface for managing Linux Containers
* (https://github.com/tsloughter/augle)[tsloughter/augle] - Auth + Google = Augle
* (https://github.com/ngmoco/gl_async_bully)[ngmoco/gl_async_bully] - Dynamic Leader Election behaviour for Erlang
* (https://github.com/ddossot/cadfaerl)[ddossot/cadfaerl] - CAching Datastructure For Applications in ERLang
* (https://github.com/keymone/wower)[keymone/wower] - yet another world of warcraft server emulator. implemented in Erlang for fun and learning.
* (https://github.com/hungryblank/emongrel2)[hungryblank/emongrel2] - erlang mongrel2 toolkit, build mongrel2 handlers and compatible servers
* (https://github.com/cooldaemon/ermlia)[cooldaemon/ermlia] - The ermlia is Erlang implementation of Kademlia. This is easy key-value store.
* (https://github.com/AbstractMachinesLab/caramel)[AbstractMachinesLab/caramel] - :candy: An Erlang backend to the OCaml compiler
* (https://github.com/darrikmazey/erlmon)[darrikmazey/erlmon] - host and network monitoring suite written in erlang
* (https://github.com/jkakar/aws-erlang)[jkakar/aws-erlang] - AWS clients for Erlang
* (https://github.com/lambdaclass/holiday_ping)[lambdaclass/holiday_ping] - Erlang + ClojureScript app to send holiday reminders
* (https://github.com/joergen7/gruff)[joergen7/gruff] - A basic worker pool manager for Erlang to showcase gen_pnet.
* (https://github.com/artefactop/elibphonenumber)[artefactop/elibphonenumber] - Erlang port for use libphonenumber from erlang
* (https://github.com/zuiderkwast/jsonrpc2-erlang)[zuiderkwast/jsonrpc2-erlang] - JSON-RPC 2.0 for Erlang
* (https://github.com/jeraymond/leader_cron)[jeraymond/leader_cron] - Cron for Erlang clusters
* (https://github.com/daleharvey/erlang_util)[daleharvey/erlang_util] - Collection of random handy erlang scripts
* (https://github.com/rabbitmq/rabbitmq-top)[rabbitmq/rabbitmq-top] - Adds top-like information on the Erlang VM to the management plugin.
* (https://github.com/KristianPoslek/erlang-dht)[KristianPoslek/erlang-dht] - A very simple example of implementing a structured P2P network (DHT) in Erlang.
* (https://github.com/project-fifo/eplugin)[project-fifo/eplugin] - An erlang plugin manager
* (https://github.com/extend/goldrush)[extend/goldrush] - @deprecated Small, Fast event processing and monitoring for Erlang/OTP applications.
* (https://github.com/bmizerany/redis-erl)[bmizerany/redis-erl] - Minimilast Redis Client for Erlang
* (https://github.com/archaelus/errd)[archaelus/errd] - Erlang RRDTool library
* (https://github.com/shopgun/graphql-erlang)[shopgun/graphql-erlang] - GraphQL implementation in Erlang.
* (https://github.com/shopgun/turtle)[shopgun/turtle] - A wrapper on the RabbitMQ Erlang Client (Erlang)
* (https://github.com/erlware-deprecated/ktuo)[erlware-deprecated/ktuo] - json encoder/decoder for Erlang
* (https://github.com/matehat/cqerl)[matehat/cqerl] - Native Erlang CQL client for Cassandra
* (https://github.com/litaocheng/gen-erl-app)[litaocheng/gen-erl-app] - the script to generate an erlang app skeleton
* (https://github.com/groupoid/pts)[groupoid/pts] - Pure Type System for Erlang
